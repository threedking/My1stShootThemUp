...
{
    this->Cost = EEnvTestCost::Low;
    this->ValidItemType = UEnvQueryItemType_ActorBase::StaticClass();
...
void UEnvQueryTest_PickupCouldBeTaken::RunTest(FEnvQueryInstance& QueryInstance) const 
{
    ...
    for (FEnvQueryInstance::ItemIterator It(this, QueryInstance); It; ++It)
    {
        ...
        It.SetScore(this->TestPurpose, this->FilterType, CouldBeTaken, WantsBeTakable);
    }
}